...
export const HeavyBowgunAttacks = [
  ...
  { name: "Dragon Lv1", mv: 8, rawEle: 20, elementType: "Dragon" },
  { name: "Dragon Lv2", mv: 10, rawEle: 25, elementType: "Dragon" },
  { name: "Fire Lv1", mv: 8, rawEle: 20, elementType: "Fire" },
  { name: "Fire Lv2", mv: 10, rawEle: 25, elementType: "Fire" },
  { name: "Ice Lv1", mv: 8, rawEle: 20, elementType: "Ice" },
  { name: "Ice Lv2", mv: 10, rawEle: 25, elementType: "Ice" },
  { name: "Thunder Lv1", mv: 8, rawEle: 20, elementType: "Thunder" },
  { name: "Thunder Lv2", mv: 10, rawEle: 25, elementType: "Thunder" },
  { name: "Water Lv1", mv: 8, rawEle: 20, elementType: "Water" },
  { name: "Water Lv2", mv: 10, rawEle: 25, elementType: "Water" },
  { name: "Dragon Lv1", mv: 20, rawEle: 44, elementType: "Dragon" },
